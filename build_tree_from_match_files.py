...
try:
	...
	with open(f'/mnt/home/{user}/ceph/tracked_embryos/{movie}/csvs/test/graph.csv', 'a') as csv_file:
...
try:
	...
	with open(f'/mnt/home/{user}/ceph/tracked_embryos/{movie}/csvs/test/edges.csv', 'a') as csv_file:
